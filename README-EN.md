...
# Submission
send your report to xcd19@mails.tsinghua.edu.cn with the subject "2024-summer-genAI-TA-Diffusion-|your name|".
## report format
title, your name, your student ID, and the course name.

## Derivation of loss function

xxxx latex or hand-wirtting equations
...
### results
report how long and how many steps you've trained the model, and the samples generated by the model.


## Open problems(Optional)
the answer to the open problem.
